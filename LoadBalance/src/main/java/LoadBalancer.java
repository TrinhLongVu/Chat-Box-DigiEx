...
import utils.Utils;
import utils.chat.ClientInfo;
import utils.chat.Database;
...
public class LoadBalancer {
    ...
    public static void main(String[] args) {
        Logger.getLogger(LoadBalancer.class.getName()).log(Level.INFO, "LoadBalancing is running.....");
        new LoadBalancer();
